...
exports.responFail = exports.responSess = exports.uInfo = exports.gamehall = exports.Authorization = exports.baseUrl = void 0;
...
const responFail = (data = {}) => {
    return {
        data,
        status: { code: "0", message: "xxxx", datetime: moment().format('YYYY-MM-DD HH:mm:ss') }
    };
};
